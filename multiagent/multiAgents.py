...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState: GameState, action):
        ...
        for newstate in newGhostStates:
            newGhostPacDist += [manhattanDistance(newPos,newstate.getPosition())]
        
        minGhostDistance = min(newGhostPacDist)         # We get minimum of the distances between the agent and the new ghost states
