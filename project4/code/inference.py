...
def constructBayesNet(gameState: hunters.GameState):
    ...
    - populate `edges` with evedry edge in the Bayes Net. we will represent each
    ...
    #assigning all the constatnts to the corresponding variables and storing the posn tupple of the edges
